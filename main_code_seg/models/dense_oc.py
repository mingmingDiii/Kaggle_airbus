...
from .oc.oc_net import BaseOC
from .oc.inplace_abn import ActivatedBatchNorm


class DENSE_OC(nn.Module):
    def __init__(self,pretrained=True,reduction=2):
        ...
        self.decoder5 = Decoder_OC(256+256,256,64,reduction)
        self.decoder4 = Decoder_OC(64+128,128,64,reduction)
        self.decoder3 = Decoder_OC(64+64,64,64,reduction)
        self.decoder2 = Decoder_OC(64,   32,64,reduction)
        self.decoder1 = Decoder_OC(64, 32, 64, reduction)
...
class Decoder_OC(nn.Module):
    def __init__(self,in_channels,channels,out_channels,reduction=2):
        super(Decoder_OC,self).__init__()
        ...
        self.block = nn.Sequential(
            ...
            ActivatedBatchNorm(channels),
            BaseOC(in_channels=channels, out_channels=channels,
                   key_channels=channels // 2,
                   value_channels=channels // 2,
                   dropout=0.2),

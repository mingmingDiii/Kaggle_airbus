...
from main_code_seg.models.new_base import senet



class SE154_NORMAL(nn.Module):
    def __init__(self,pretrained=True,reduction=2):
        super().__init__()
        self.backbone = senet.senet154()

        self.encoder1 = self.backbone.layer0
        ...
        #self.decoder1 = Decoder(64, 64, 64, reduction)
    ...
    def forward(self, x):
        ...
        e1 = self.encoder1(x)  #128/2    #128,192,192
        #e1 = self.scse1(e1)
        e2 = self.encoder2(e1) #256/2 #128,96,96
        #e2 = self.scse2(e2)
        e3 = self.encoder3(e2) #512/2  print('e3',e3.size())#256,48,48
        #e3 = self.scse3(e3)
        e4 = self.encoder4(e3)#1024/2  print('e4',e4.size()) #512,24,24
        #e4 = self.scse4(e4)

        #e5 = self.encoder5(e4)#2048/2
